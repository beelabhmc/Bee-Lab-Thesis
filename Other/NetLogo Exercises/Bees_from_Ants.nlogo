...
to setup-food  ;; patch procedure
  ; Bees, every square has chance of being food source
...
to look-for-food  ;; turtle procedure
  ...
  [ set color orange + 1     ;; pick up food
    set pcolor black      ;; and reduce the food source
...
"pen-3" 1.0 0 -7500403 true "" "plotxy ticks sum [food] of patches with [pcolor = pink]"
